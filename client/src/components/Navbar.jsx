                ...
                <div className="flex justify-between">
                    <div className="flex space-x-7">
                        <div>
                            <Link to="/" className="flex items-center py-4 px-2">
                                <span className="font-semibold text-gray-500 text-lg">MyPortfolio</span>
                            </Link>
                        </div>
                        <div className="hidden md:flex items-center space-x-1">
                            ...
                            <Link to="/projects" className="py-4 px-2 text-gray-500 hover:text-green-500 transition duration-300">Projects</Link>
                    ...
                    <div className="hidden md:flex items-center space-x-3 ">
                        {user ? (
                            ...
                            <Link to="/login" className="py-2 px-2 font-medium text-gray-500 rounded hover:bg-green-500 hover:text-white transition duration-300">Admin Login</Link>
                        )}
                    </div>
                </div>
            </div>
